...
class DPTNGenerator(BaseNetwork):
    ...
    def forward(self, source_image, source_bone, target_bone,
        ...
        texture_information = [source_image, source_bone, canonical_bone] # source-canonical information
        ...
        out_image_s = None
        if is_train:
            texture_information = [source_image, source_bone, canonical_bone] # [source_image, source_bone, canonical_bone]
            out_image_s = self.De(F_s_s, texture_information)
        # Source-to-target Decoder
        texture_information = [source_image, source_bone, target_bone] # [source_image, source_bone, target_bone]
