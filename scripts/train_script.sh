...
nohup python train.py --id spade_origin --tf_log --gpu_ids 1 --type_En_c z --type_Dc spade --pose_nc 41 --batchSize 20 --num_workers 5 --dataroot /home/work/msha/datasets/fashion --continue_train > spade_origin.out &