...
import torch
from metrics.pose_estimator.lib.datasets.preprocessing import (inception_preprocess,
                                              rtpose_preprocess,
                                              ssd_preprocess, vgg_preprocess)
from metrics.pose_estimator.lib.network import im_transform
from metrics.pose_estimator.lib.config import cfg, update_config
from metrics.pose_estimator.lib.utils.common import Human, BodyPart, CocoPart, CocoColors, CocoPairsRender, draw_humans
from metrics.pose_estimator.lib.utils.paf_to_pose import paf_to_pose_cpp


parser = argparse.ArgumentParser()
parser.add_argument('--cfg', help='experiment configure file name',
                    default='./metrics/pose_estimator/experiments/vgg19_368x368_sgd.yaml', type=str)
