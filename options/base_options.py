...
class BaseOptions():
    ...
    def initialize(self, parser):
        ...
        parser.add_argument('--id', type=str, default='fashion', help='name of the experiment. It decides where to store samples and models')
        ...
        parser.add_argument('--label_nc', type=int, default=37, help='# of input pose channels. keypoint channel + limb channel')
